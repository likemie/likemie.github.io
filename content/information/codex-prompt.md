...
- For books: stop after each chapter, run `git commit -m "书名 chXX 章节名 done"`, then ask the user whether to continue
- For papers: run `git commit -m "处理完成 文件名"` after each paper is fully processed
